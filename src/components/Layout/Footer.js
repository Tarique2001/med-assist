...
export default function Footer() {
    return (
        <>
            <footer className=" bg-green-200  border-t-2 border-green-900 dark:border-gray-950 pt-[4vh] dark:bg-black ">
                <div className="mx-auto w-full max-w-screen-xl">
                    <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-950 uppercase dark:text-white">Company</h2>
                            <ul className="text-green-900 dark:text-gray-400 font-medium">
                                <li className="mb-4">
